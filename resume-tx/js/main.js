...
var canvaspython=document.getElementById("python").getContext("2d");
var canwidth=160;
var radius=70;
...
var canvue=function(){
	var deg = 0;
    var vueT = function(deg){
        var r = deg*Math.PI/180;   
        canvasvue.clearRect(0,0,canwidth,canwidth);   
        canvasvue.beginPath();  
        canvasvue.strokeStyle = "#75B143"; 
...
var python=function(){
	var deg = 0;
    var pythonT = function(deg){
        var r = deg*Math.PI/180;   
        canvaspython.clearRect(0,0,canwidth,canwidth);   
        canvaspython.beginPath();  
        canvaspython.strokeStyle = "#031A3A"; 
        canvaspython.lineWidth = 10; 
        canvaspython.arc(canwidth/2,canwidth/2,radius,0-1/2*Math.PI,r-1/2*Math.PI,false); //
        canvaspython.stroke();
    };
    var time = setInterval(function(){
    	var con=document.getElementsByTagName("section")[2];
